<?php include_once('../acoes/publicaComentario.php');
      include_once('../acoes/deleteComentario.php');
      include_once('../acoes/updateComentario.php'); ?>
    ...
    <div class="col-7">
      <div class="form-group ">
        <form action="" method="post">
          ...
          <textarea class="form-control" id="exampleFormControlTextarea1" rows="5" name="comentario"><?php echo isset($comentarioUpdate)??$comentarioUpdate ?></textarea>
